...
// configuration step. It creates a namespace called `battleTest`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", battleTest::cmake::project_name, battleTest::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", battleTest::cmake::project_version);
      return EXIT_SUCCESS;
    }
